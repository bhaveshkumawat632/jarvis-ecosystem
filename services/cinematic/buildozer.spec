...
title = Jarvis Universal

# (str) Package name
package.name = jarvis_universal
...
source.include_exts = py,png,jpg,webp,html,css,js,json,cpp,txt,sh
...
requirements = python3,kivy,flask,requests,urllib3,decorator,jinja2,werkzeug,itsdangerous,blinker,pyjnius,edge-tts,tqdm,proglog,imageio,moviepy,yt-dlp
